...
!else
	...
	!system 'grigore-stefan.sign "Hypertext Preprocessor" "build\Uninstall.exe"' = 0
...
!endif
	...
	File "port\hypertext-preprocessor-error.php"
	SetOutPath "$PathProgramData\HTTPD\conf\conf"
	File "port\hypertext-preprocessor.conf"
